"""
Django settings for IncidentResponseSimulator project.
...
ALLOWED_HOSTS = ['10.10.40.15', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'IncidentResponseSimulator.urls'
...
WSGI_APPLICATION = 'IncidentResponseSimulator.wsgi.application'
